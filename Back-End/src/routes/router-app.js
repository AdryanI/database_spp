...
// const homeDataCont = require('../controllers').dataHome; TO DEL
...
// router.get('/jumlah-siswa', verifyUser.isLogin, homeDataCont.home)   TO DEL
...
// router.post('/profileUpload', verifyUser.isLogin, profileController.profileUpload)   TO DEL
